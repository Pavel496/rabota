...
{{--      <div class="container">
      ...
      <section class="no-padding-top bg-alt">
        <div class="container">
          <div class="row">
            ...
            <div class="col-xs-12">
              <br>
              <h5>We found <strong>{{ count($users) }}</strong> matches, you're watching <i>10</i> to <i>20</i></h5>
            </div>
            ...
            <div class="col-xs-12">
              <a class="item-block" href="resume-detail.html">
                <header>
                  <img class="resume-avatar" src="/img/avatar.jpg" alt="">
                  <div class="hgroup">
                    <h4>{{ $user->name }}</h4>
                    <h5>{{ $user->email }}</h5>
                  </div>
 ...
 {{--         <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
              <a class="item-block" href="resume-detail.html">
                <header>
                  <img class="resume-avatar" src="/img/avatar-1.jpg" alt="">
                  <div class="hgroup">
            ...
            <div class="col-sm-12 col-md-6">
              <a class="item-block" href="resume-detail.html">
                <header>
                  <img class="resume-avatar" src="/img/avatar-2.jpg" alt="">
                  <div class="hgroup">
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
              <a class="item-block" href="resume-detail.html">
                <header>
                  <img class="resume-avatar" src="/img/avatar-3.jpg" alt="">
                  <div class="hgroup">
                    <h4>Mary Amiri</h4>
            ...
            <div class="col-sm-12 col-md-6">
              <a class="item-block" href="resume-detail.html">
                <header>
                  <img class="resume-avatar" src="/img/avatar-4.jpg" alt="">
                  <div class="hgroup">
