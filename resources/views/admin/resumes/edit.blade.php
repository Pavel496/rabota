        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('sphere_id[]', $sphere_ids, old('sphere_id') ? old('sphere_id') : $resume->sphere_id->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('schedule_id[]', $schedule_ids, old('schedule_id') ? old('schedule_id') : $resume->schedule_id->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($resume->avatar)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$resume->avatar) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$resume->avatar) }}"></a>
                    @endif
