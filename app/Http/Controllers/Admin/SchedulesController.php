...
class SchedulesController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $vacancies = \App\Vacancy::whereHas('schedule_id',
                    function ($query) use ($id) {
                        $query->where('id', $id);
                    })->get();$resumes = \App\Resume::whereHas('schedule_id',
                    function ($query) use ($id) {
                        $query->where('id', $id);
                    })->get();
        ...
        return view('admin.schedules.show', compact('schedule', 'vacancies', 'resumes'));
    }
