...
@section('content')
    ...
    {!! Form::model($vacancy, ['method' => 'PUT', 'route' => ['admin.vacancies.update', $vacancy->id], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('sphere_id[]', $sphere_ids, old('sphere_id') ? old('sphere_id') : $vacancy->sphere_id->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('schedule_id[]', $schedule_ids, old('schedule_id') ? old('schedule_id') : $vacancy->schedule_id->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($vacancy->logotype)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$vacancy->logotype) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$vacancy->logotype) }}"></a>
                    @endif
